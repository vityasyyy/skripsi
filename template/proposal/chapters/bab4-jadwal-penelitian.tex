...
\begin{enumerate}
    ...
    \item \textbf{Implementasi ArgoCD + Baseline Manual (Agustus -- Oktober 2026)}
    ...
    Analisis data meliputi: uji normalitas (Shapiro--Wilk), uji hipotesis (\textit{independent samples t-test} atau \textit{Mann--Whitney U test}), perhitungan ukuran efek (Cohen's $d$ atau Cliff's $\delta$), dan interpretasi hasil dalam konteks H$_0$ dan H$_1$. Pembahasan mencakup identifikasi skenario drift yang paling berdampak, faktor yang mempengaruhi hasil, serta ancaman terhadap validitas internal dan eksternal penelitian.

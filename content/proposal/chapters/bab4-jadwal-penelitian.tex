...
\begin{enumerate}
    ...
    Analisis data meliputi: uji normalitas (Shapiro--Wilk), uji hipotesis (\textit{independent samples t-test} atau \textit{Mann--Whitney U test}), perhitungan ukuran efek (Cohen's $d$ atau Cliff's $\delta$), dan interpretasi hasil dalam konteks H0 dan H1. Pembahasan mencakup identifikasi skenario drift yang paling berdampak, faktor yang mempengaruhi hasil, serta ancaman terhadap validitas internal dan eksternal penelitian.

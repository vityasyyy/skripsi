...
\begin{tikzpicture}[
    ...
    metriclabel/.style={rectangle, rounded corners=3pt, draw=#1, fill=#1,
                        text=white, minimum width=3.4cm, minimum height=0.7cm,
                        align=center, font=\scriptsize\bfseries, line width=1pt},
    metricdesc/.style={font=\tiny, align=left, text width=3.1cm},
...
% R2
\node[metriclabel=driftred, right=0.7cm of r1label] (r2label) {R2: Waktu (detik)};
...
% R3
\node[metriclabel=metricpurple, right=0.7cm of r2label] (r3label) {R3: Traceability};
